...
namespace Common.DistributedCaching.UnitTests.AppFabric
{
	...
	public class AppFabricDistributedCacheUnitTests
	{
		...
		private class TestContext
		{
			...
			public DistributedCaching.AppFabric.DistributedCache Sut
			{
				get { return new DistributedCaching.AppFabric.DistributedCache(_cacheWrapper, _connectivityManager); }
			}
